 ...
 */
package JPEG_Data.exif;

import java.io.File;
import java.io.FileNotFoundException;

import JPEG_Data.Directory;
import JPEG_Data.JpegProcessingException;
import JPEG_Data.JpegSegmentReader;
import JPEG_Data.Metadata;
import JPEG_Data.MetadataReader;
import JPEG_Data.Rational;
...
//    work out what to do with this calculation
...
*/
    ...
    private int calculateTagValueOffset(int byteCount, int dirEntryOffset)
    {
        if (byteCount > 4) {
            ...
            //    if we're reading FujiFilm makernote tags, the offset is relative to the start of the makernote itself, not the TIFF segment
    ...
    private int get32Bits(int offset)
    {
        ...
        //    report this bug in IntelliJ -- 0xFF000000 too large ???
        if (motorollaByteOrder) {
            // Motorola big first
