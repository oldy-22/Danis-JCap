...
public class DX6340_InfoPanel extends JFrame {

	public JCap parent = null;
	
	// constructor
	public DX6340_InfoPanel() {
		...
		try {
			JEditorPane je = new JEditorPane (getClass().getResource("/images/Kodak_DX6340.html"));
			...
			JOptionPane.showMessageDialog(this, "KameraInfoFile file not found.", "Read error", JOptionPane.WARNING_MESSAGE);
		} 
		...
		*/
		...
		// Title and icon
		// ---------------------------------------------------------------------
		setTitle("Kodak EasyShare DX6340 - EXIF-Infos");
	...
	protected void closeWindow() {
		...
		parent.camInfoPanelVisible = false;
